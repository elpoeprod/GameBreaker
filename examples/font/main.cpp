...
int main() {
    ...
    GBFont *font0=font::add("sourcesans.ttf",16,0,0);
    GBFont *font0_italy=font::add("sourcesans.ttf",16,0,1);
    GBFont *font0_heavy=font::add("sourcesans.ttf",16,1,0);
    GBFont *font1=font::add("sourcesans.ttf",16,1,1);
    ...
    while(gb::running()) {
        ...
        draw::set_font(font0_italy);
        draw::text_rt(0, 20, "I am italic.");

        draw::set_font(font0_heavy);
