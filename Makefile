...
all:
	...
	$(CXX_CMD) gb/gb_sound.cpp 	-o build/sound.o $(CXX_ARGS_SOLOUD) $(CXX_ARGS_TAGLIB)
	...
	$(CXX_CMD) gb/gamebreaker.cpp 	-o build/main.o $(CXX_ARGS_SOLOUD) $(CXX_ARGS_TAGLIB)
	...
	$(CXX_COMPILER) -g -ggdb -fpic -rdynamic -Lstatic -shared -o $(LIB_NAME) build/*.o $(CXX_ARGS_LIBS) $(CXX_ARGS_GTK) include/SoLoud/libSoLoud_MA.a $(CXX_ARGS_TAGLIB) #-lstatic 
